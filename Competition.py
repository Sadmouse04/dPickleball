...
unity_env = UnityEnvironment(r"C:\Users\user\PycharmProjects\Pickleball\dPickleball BuildFiles\Training\Windows\dp.exe", side_channels=[string_channel, channel])
